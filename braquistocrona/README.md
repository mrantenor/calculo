...
$$\normalsize{t =\frac{1}{\sqrt{2g}} \int_{x_1}^{x_2} \sqrt\frac{1+\dot{y}^2}{x}dx}$$  
Neste ponto, podemos utilizar a equação de Euler, atribuíndo o integrando como função a ser derivada:  
...
```
    plt.plot(linspace(0,1,100)*sin(braq().theta[i])+braq().y_position[i],   
             ...
             lw=0.7,c='k')            
```
![Figura 5|500](../images/braq_3.gif)
...
![Figura 9|500](../images/braq_7.gif)
